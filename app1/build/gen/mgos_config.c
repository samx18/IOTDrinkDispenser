...
const struct mgos_conf_entry mgos_config_schema_[201] = {
  {.type = CONF_TYPE_OBJECT, .key = "", .num_desc = 200},
  ...
  {.type = CONF_TYPE_OBJECT, .key = "bt", .num_desc = 6},
  ...
  {.type = CONF_TYPE_OBJECT, .key = "eth", .num_desc = 4},
  ...
  {.type = CONF_TYPE_BOOL, .key = "is_trusted", .offset = offsetof(struct mgos_config, rpc.gatts.is_trusted)},
  ...
  {.type = CONF_TYPE_BOOL, .key = "is_trusted", .offset = offsetof(struct mgos_config, rpc.mqtt.is_trusted)},
...
int         mgos_config_get_rpc_gatts_is_trusted(struct mgos_config *cfg) {
  return cfg->rpc.gatts.is_trusted;
}
...
int         mgos_config_get_rpc_mqtt_is_trusted(struct mgos_config *cfg) {
  return cfg->rpc.mqtt.is_trusted;
}
